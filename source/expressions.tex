...
\begin{itemize}
  \item
  if the value is of scalar type,
  it is not an indeterminate value\iref{basic.indet},
  ...
  it does not designate an immediate function,

  \item
  if the value is of class type,
  each non-static data member of reference type refers to
  an entity that is a permitted result of a constant expression,

  \item
  if the value is of class type,
  the value of each non-static data member
  of object type satisfies these constraints, and

  \item
  if the value is of array type,
  the value of each element satisfies these constraints.
\end{itemize}
An entity is a
